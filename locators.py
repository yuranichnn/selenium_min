...
PRICING_BUTTON = ("xpath", "//header//a[normalize-space()='Pricing']")
...
PYTHON_RATING_ZOOKEEPER = ("xpath", "//main//div[div[text()='Zookeeper with Python']]//span[contains(text(),'.')]")
PYTHON_HR_ZOOKEEPER = ("xpath", "//main//div[div[text()='Zookeeper with Python']]//span[contains(text(),'hr')]")
PYTHON_LVL_ZOOKEEPER = ("xpath", "//main//div[div[text()='Zookeeper with Python']]//span[text()='Easy']")
